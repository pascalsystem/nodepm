...
${OBJECTDIR}/app/ConfigLoader.o: app/ConfigLoader.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/ConfigLoader.o app/ConfigLoader.cpp

${OBJECTDIR}/app/HelpMe.o: app/HelpMe.cpp 
	${MKDIR} -p ${OBJECTDIR}/app
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/HelpMe.o app/HelpMe.cpp

${OBJECTDIR}/app/Manager.o: app/Manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/app
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/Manager.o app/Manager.cpp

${OBJECTDIR}/app/ProxyClient.o: app/ProxyClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/app
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/ProxyClient.o app/ProxyClient.cpp

${OBJECTDIR}/lib/Command/CommandAbstract.o: lib/Command/CommandAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Command
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Command/CommandAbstract.o lib/Command/CommandAbstract.cpp

${OBJECTDIR}/lib/Command/CommandStdIn.o: lib/Command/CommandStdIn.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Command
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Command/CommandStdIn.o lib/Command/CommandStdIn.cpp

${OBJECTDIR}/lib/Command/CommandUnixSock.o: lib/Command/CommandUnixSock.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Command
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Command/CommandUnixSock.o lib/Command/CommandUnixSock.cpp

${OBJECTDIR}/lib/Logger/LoggerAbstract.o: lib/Logger/LoggerAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Logger
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Logger/LoggerAbstract.o lib/Logger/LoggerAbstract.cpp

${OBJECTDIR}/lib/Logger/LoggerConsole.o: lib/Logger/LoggerConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Logger
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Logger/LoggerConsole.o lib/Logger/LoggerConsole.cpp

${OBJECTDIR}/lib/Logger/LoggerFileOut.o: lib/Logger/LoggerFileOut.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Logger
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Logger/LoggerFileOut.o lib/Logger/LoggerFileOut.cpp

${OBJECTDIR}/lib/Process/ConfigAbstract.o: lib/Process/ConfigAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Process
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Process/ConfigAbstract.o lib/Process/ConfigAbstract.cpp

${OBJECTDIR}/lib/Process/ConfigNodeJS.o: lib/Process/ConfigNodeJS.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Process
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Process/ConfigNodeJS.o lib/Process/ConfigNodeJS.cpp

${OBJECTDIR}/lib/Process/Item.o: lib/Process/Item.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Process
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Process/Item.o lib/Process/Item.cpp

${OBJECTDIR}/lib/Settings/SettingsAbstract.o: lib/Settings/SettingsAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Settings
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Settings/SettingsAbstract.o lib/Settings/SettingsAbstract.cpp

${OBJECTDIR}/lib/Settings/SettingsIni.o: lib/Settings/SettingsIni.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Settings
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Settings/SettingsIni.o lib/Settings/SettingsIni.cpp

${OBJECTDIR}/lib/Socket/SocketServerAbstract.o: lib/Socket/SocketServerAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Socket/SocketServerAbstract.o lib/Socket/SocketServerAbstract.cpp

${OBJECTDIR}/lib/Socket/SocketServerPort.o: lib/Socket/SocketServerPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Socket/SocketServerPort.o lib/Socket/SocketServerPort.cpp

${OBJECTDIR}/lib/Socket/SocketServerUnix.o: lib/Socket/SocketServerUnix.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Socket/SocketServerUnix.o lib/Socket/SocketServerUnix.cpp

${OBJECTDIR}/lib/Utils/Directory.o: lib/Utils/Directory.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Utils/Directory.o lib/Utils/Directory.cpp

${OBJECTDIR}/lib/Utils/FileWriter.o: lib/Utils/FileWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Utils/FileWriter.o lib/Utils/FileWriter.cpp

${OBJECTDIR}/lib/Utils/ProcSingleton.o: lib/Utils/ProcSingleton.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Utils/ProcSingleton.o lib/Utils/ProcSingleton.cpp

${OBJECTDIR}/lib/Utils/User.o: lib/Utils/User.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/Utils/User.o lib/Utils/User.cpp
